...
cat jquery.js collapse.js affix.js dropdown.js tab.js transition.js modal.js leaflet.js leaflet-providers.js leaflet-loading.js oms.js noui.js ascii.js map.js > main-dev.js
