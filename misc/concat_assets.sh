...
cat jquery.js collapse.js affix.js dropdown.js tab.js transition.js modal.js leaflet.js leaflet-providers.js noui.js jquery.validate.js jquery-ui.min.js maskedinput.js Google.js > backend.js
cd ../stylesheets
