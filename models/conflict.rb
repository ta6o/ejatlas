...
=end
  ...
  def as_button(options={})
    ...
    if options.empty?
      ...
      html = "<p class='conflict-button' data-id='#{self.id}'><span class='ctitle'>#{self.name}</span>&nbsp;<a href='/conflict/#{self.slug}'><span class='glyphicon glyphicon-link'></span></a><span class='cdata'>"
